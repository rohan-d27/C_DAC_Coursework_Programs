    ...
    public static class EmployeeDao
    {
        public static List<Employee> GetAllEmployees()
        {
            ...
            try
            {
                ...
                con.Open();
                MySqlDataReader resultSet = cmd.ExecuteReader(); //Perform Operation against database
                                                                 //2.cmd.ExecuteNonQuery   ---------Insert, Update, delete record into table
                                                                 //3.cmd.ExecuteScalar--------Aggregate functinos
                while (resultSet.Read())
                {
                    Employee emp = new Employee();
                    emp.Id = int.Parse(resultSet["ID"].ToString());  //int.Parse, float.Parse, double.Parse
