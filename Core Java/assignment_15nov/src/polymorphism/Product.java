...
public boolean equals(Object obj)
{
	...
	if(this.getProductname().equals(temp.getProductname())&&this.getPrice()==temp.getPrice()&&this.getDescription().equals(temp.getDescription())
		&& this.getExpdate().equals(temp.getExpdate()))
	{
		return true;
	}
	else
